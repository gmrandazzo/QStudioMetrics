...
#  LIBSCIENTIFIC_LIBRARY_DIRS - The libraries path
...
find_path(LIBSCIENTIFIC_LIBRARY_PATH
    NAMES scientific
    PATHS ${LIBSCIENTIFIC_ROOT_DIR}
    PATH_SUFFIXES "lib" "lib32" "lib64"
    DOC "The LIBSCIENTIFIC library path"
)

include(FindPackageHandleStandardArgs)
# handle the QUIETLY and REQUIRED arguments and set LOGGING_FOUND to TRUE
# if all listed variables are TRUE
find_package_handle_standard_args(libscientific DEFAULT_MSG LIBSCIENTIFIC_LIBRARY LIBSCIENTIFIC_LIBRARY_PATH LIBSCIENTIFIC_INCLUDE_DIR)
...
if (LIBSCIENTIFIC_FOUND)
    ...
    set(LIBSCIENTIFIC_LIBRARY_DIRS ${LIBSCIENTIFIC_LIBRARY_PATH})
    #set(LIBSCIENTIFIC_DEFINITIONS "-DWIN_SCIENTIFIC")
endif()

# Tell cmake GUIs to ignore the "local" variables.
mark_as_advanced(LIBSCIENTIFIC_ROOT_DIR LIBSCIENTIFIC_LIBRARY_DIRS LIBSCIENTIFIC_INCLUDE_DIR LIBSCIENTIFIC_LIBRARY)
