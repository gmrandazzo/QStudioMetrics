...
DataPoint::DataPoint() : m_x(0.f), m_y(0.f), m_z(0.f), m_name("No name"), m_color(Qt::black), m_width(10), m_radius(5), m_selection(false), m_visible(true), m_lvisible(false), m_type(CIRCLE)
{
}

DataPoint::DataPoint(qreal x, qreal y, QString name) : m_x(x), m_y(y), m_z(0.f), m_name(name), m_color(Qt::black),  m_width(10), m_radius(10), m_selection(false), m_visible(true), m_lvisible(false), m_type(CIRCLE)
{
}

DataPoint::DataPoint(qreal x, qreal y, qreal z, QString name) : m_x(x), m_y(y), m_z(z), m_name(name), m_color(Qt::black),  m_width(10), m_radius(10), m_selection(false), m_visible(true), m_lvisible(false), m_type(CIRCLE)
{
}
...
void DataPoint::setMarkerType(MarkerType type)
{
  m_type = type;
}
...
MarkerType DataPoint::marker() const
{
  return m_type;
}
