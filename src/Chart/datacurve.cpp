...
void DataCurve::setName(QString name) { m_name = name; }

void DataCurve::setColor(const QColor &color) { m_color = color; }

void DataCurve::setRadius(int radius) { m_radius = radius; }

void DataCurve::setWidth(int width) { m_width = width; }

void DataCurve::setVisible(bool visible) { m_visible = visible; }
...
QColor DataCurve::color() const { return m_color; }

LTYPE DataCurve::getStyle() const { return lt; }

int DataCurve::radius() const { return m_radius; }
