...
public:
  ...
  virtual void addPoint(qreal x, qreal y, QString name, QColor color, int radius) = 0;
  virtual void addPoint(qreal x, qreal y, qreal z, QString name, QColor color, int radius) = 0;
