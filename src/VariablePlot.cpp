...
ScatterPlot2D* VariablePlot::VariableVSVariable()
{
  /*
...
//       NewMatrix(&mxlst.last(), objects_[i].size(), 2);
    ...
    ScatterPlot2D *plt2D = new ScatterPlot2D(mxlst, selobjects,  &projects->value(pid)->getMATRIXList(), xhash, yhash,  &projects->value(pid)->getObjectLabels(), &projects->value(pid)->getVariableLabels(), vname1, vname2, QString("Variable %1 VS Variable %2").arg(vname1).arg(vname2), ScatterPlot2D::SCORES);
    ...
    ScatterPlot2D *plt2D = new ScatterPlot2D(mxlst, selobjects, vname1, vname2, QString("Variable %1 VS Variable %2").arg(vname1).arg(vname2));
