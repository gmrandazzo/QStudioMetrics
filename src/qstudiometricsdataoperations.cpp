...
void DeserializeDVector(QString serialized_dvector, dvector *v) {
  if (serialized_dvector.compare("NULL", Qt::CaseInsensitive) == 0 ||
...
void DeserializeUIVector(QString serialized_uivector, uivector *v) {
  if (serialized_uivector.compare("NULL", Qt::CaseInsensitive) == 0 ||
...
void DeserializeMatrix(QString serialized_mx, matrix *mx) {
  if (serialized_mx.compare("NULL", Qt::CaseInsensitive) == 0 ||
      serialized_mx.size() == 0) {
    return;
  } else {
...
void DeserializeTensor(QString serialized_ar, tensor *ar) {
  if (serialized_ar.compare("NULL", Qt::CaseInsensitive) == 0 ||
      serialized_ar.size() == 0) {
    return;
  } else {
