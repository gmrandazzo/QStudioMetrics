...
void SelectionStyleColor::Cancel() { reject(); }

void SelectionStyleColor::OK() { accept(); }
...
SelectionStyleColor::SelectionStyleColor(QStringList &xvarname_,
  ...
  connect(ui.actionSelectColor, SIGNAL(clicked(bool)),
          SLOT(SetSolidSymbolColor()));
  connect(ui.colorvarvaltype, SIGNAL(currentIndexChanged(int)),
          SLOT(SetVariableTypeSymbolColor()));
  ...
  connect(ui.colorvarlist, SIGNAL(currentIndexChanged(int)),
          SLOT(SetVariableSymbolColor()));
  connect(ui.okButton, SIGNAL(clicked(bool)), SLOT(OK()));
  connect(ui.cancelButton, SIGNAL(clicked(bool)), SLOT(Cancel()));
...
SelectionStyleColor::SelectionStyleColor(QStringList &xvarname_,
  ...
  connect(ui.colorvarlist, SIGNAL(currentIndexChanged(int)),
          SLOT(SetVariableSymbolColor()));
  connect(ui.colorvarlevels, SIGNAL(currentIndexChanged(int)),
          SLOT(SetVariableLevelSymbolColor()));
  connect(ui.okButton, SIGNAL(clicked(bool)), SLOT(OK()));
  connect(ui.cancelButton, SIGNAL(clicked(bool)), SLOT(Cancel()));
  connect(ui.solidcolor, SIGNAL(clicked(bool)), SLOT(CheckUncheck()));
  connect(ui.variablecolor, SIGNAL(clicked(bool)), SLOT(CheckUncheck()));
