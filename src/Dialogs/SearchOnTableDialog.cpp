 ...
 *
 * Dialog for searchontable operations.
 *
...
void SearchOnTableDialog::Ok() { accept(); }

void SearchOnTableDialog::Cancel() { reject(); }
...
QString SearchOnTableDialog::getLabel() { return ui.lineEdit->text(); }
