...
void MLRPlot::RecalcVSExperimentalAndPrediction(ScatterPlot2D **plot2D)
{
  ...
  qDebug()<< "Plotting MLR Recalculated VS Experimental and Predictions: " << projects->value(pid)->getProjectName();
...
{
  qDebug()<< "Plotting MLR Prediction VS Experimental and Predictions: " << projects->value(pid)->getProjectName();
  QString projectname = projects->value(pid)->getProjectName();
  QString modelname = projects->value(pid)->getMLRModel(mid)->getName();
  QStringList varname = projects->value(pid)->getMLRModel(mid)->getYVarName();
  // Get Prediction
...
{
  qDebug()<< "Plotting MLR Beta Coefficients: " << projects->value(pid)->getProjectName();
  QString projectname = projects->value(pid)->getProjectName();
  QString modelname = projects->value(pid)->getMLRModel(mid)->getName();
...
{
  qDebug()<< "Plotting MLR Recalculated VS Experimental: " << projects->value(pid)->getProjectName();
  QString projectname = projects->value(pid)->getProjectName();
  QString modelname = projects->value(pid)->getMLRModel(mid)->getName();
  QStringList varname = projects->value(pid)->getMLRModel(mid)->getYVarName();
  // Get Prediction
...
{
  qDebug()<< "Plotting MLR Experimental VS Recalculated Residuals: " << projects->value(pid)->getProjectName();
  QString projectname = projects->value(pid)->getProjectName();
  QString modelname = projects->value(pid)->getMLRModel(mid)->getName();
  QStringList varname = projects->value(pid)->getMLRModel(mid)->getYVarName();
...
{
  qDebug()<< "Plotting MLR Predicted VS Experimental: " << projects->value(pid)->getProjectName();
  QString projectname = projects->value(pid)->getProjectName();
  QString modelname = projects->value(pid)->getMLRModel(mid)->getName();
  QStringList varname = projects->value(pid)->getMLRModel(mid)->getYVarName();
  // Get Prediction
...
{
  qDebug()<< "Plotting MLR Experimental VS Predicted Residuals: " << projects->value(pid)->getProjectName();
  QString projectname = projects->value(pid)->getProjectName();
  QString modelname = projects->value(pid)->getMLRModel(mid)->getName();
  QStringList varname = projects->value(pid)->getMLRModel(mid)->getYVarName();
